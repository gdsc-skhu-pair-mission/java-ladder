...
class PlayerValidatorTest {
    ...
    void playerNameValidator_공백_포함() {
        ...
        assertThrows(LadderGameValidationException.BlankPlayerNameException.class,
    ...
    void playerNameValidator_이름_길이_초과() {
        ...
        assertThrows(LadderGameValidationException.InvalidPlayerNameLengthException.class,
                () -> PlayerValidator.validatePlayerNameIsCorrect(playerNames));
    }
    ...
    void playerNameValidator_중복_입력() {
        ...
        assertThrows(LadderGameValidationException.DuplicatedPlayerNameException.class,
                () -> PlayerValidator.validatePlayerNameIsCorrect(playerNames));
    }
}
